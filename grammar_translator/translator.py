...
def buscador(simbolos, banco_de_reglas):
  simbolos_copia = simbolos
  go = True
  while go == True:
    reglas, simbolos_nt = otro_buscador_mas(simbolos_copia, banco_de_reglas)
...
def otro_buscador_mas(simbolos, banco_de_reglas):
    lista_de_reglas = []
    lista_de_keys = []
